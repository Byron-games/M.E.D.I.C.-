 ...
 *
 * Configure via: medic.telemedicine.provider = DAILY | JITSI
 */
@Component
...
public class VideoProviderClient {
    ...
    @Value("${medic.telemedicine.provider:JITSI}")
    private String provider;

    @Value("${medic.telemedicine.daily.api-key:}")
    private String dailyApiKey;

    @Value("${medic.telemedicine.jitsi.base-url:https://meet.jit.si}")
    private String jitsiBaseUrl;

    @Value("${medic.telemedicine.base-url:https://meet.medic.com}")
    private String medicBaseUrl;
    ...
    private RoomDetails createJitsiRoom(String roomName, boolean lowBandwidth) {
        String baseUrl = lowBandwidth ? jitsiBaseUrl : medicBaseUrl;
